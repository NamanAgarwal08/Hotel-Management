...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<String>> handleDataIntegrityException(DataIntegrityViolationException e){
        return new ResponseEntity<>(new ApiResponse<>(false, "Duplicate entry detected!", null), HttpStatus.NOT_ACCEPTABLE);
    }
